...
class QuestExchangeViewHolder (
    ...
    fun binding(questExchange: QuestExchange, context: Context) {
    ...
    private fun setTheme(questExchange: QuestExchange, context: Context) {
        ...
        val rectangleCircle = ContextCompat.getDrawable(context, R.drawable.shape_square_circle) as GradientDrawable
        val upperRound = ContextCompat.getDrawable(context, R.drawable.shape_upper_round_10) as GradientDrawable
