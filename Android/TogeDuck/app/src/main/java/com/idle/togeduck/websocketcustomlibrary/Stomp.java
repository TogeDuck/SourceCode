...
import com.idle.togeduck.websocketcustomlibrary.provider.OkHttpConnectionProvider;
import com.idle.togeduck.websocketcustomlibrary.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(com.idle.togeduck.websocketcustomlibrary.provider.ConnectionProvider connectionProvider) {
