...
class MyFavoriteAdapter(private var iMyFavorite: IMyFavorite) : ListAdapter<FavoriteIdol, MyFavoriteViewHolder>(TogeDuckDiffUtil.favoriteIdolDiffUtilItemCallback) {
