...
class QuestTalkFragment : Fragment(), IQuestTalkDetail {
    ...
    fun questTalkDummyData() : List<QuestTalk> {
        ...
        val talk4 = QuestTalk("익명의 고양이","asdlfkjasl;kdfj;laskdjf;alskdjf;lsakdjflkwjeoiruqwoieruowqpieruwqoeiruwqoeiruqwoieruqwpoeiruwoieruwoeiruwoieruwoieruwoieurowie")
        ...
        val talk12 = QuestTalk("익명의 오리너구리","채팅 sdkfjals;dkfjlaksdjflkasdjfwoeirqupwoeiraosxvupoaisiodfausdyfoiuaywiefuyasoidufyasoidufyasoidufyaosidufyai좋네요")
