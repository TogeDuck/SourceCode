package com.idle.togeduck.websocketcustomlibrary;
...
import com.idle.togeduck.websocketcustomlibrary.dto.StompCommand;
...
import com.idle.togeduck.websocketcustomlibrary.pathmatcher.PathMatcher;
import com.idle.togeduck.websocketcustomlibrary.pathmatcher.SimplePathMatcher;
import com.idle.togeduck.websocketcustomlibrary.provider.ConnectionProvider;
...
public class StompClient {
    ...
    public Completable send(String destination, String data, List<StompHeader> additionalHeaders) {
        List<StompHeader> headers = new ArrayList<>();
